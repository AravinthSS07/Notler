'''
THIS IS JUST THE MAIN FILE THE GUI FILES ARE NOT INCLUDED IN THIS REPOSITORY IF YOU WANT 
PLUS YOU CAN'T DISTRUBUTE CLOSED VERSION OF THIS PROJECT (REFFER TO THE LICENSE FOR MORE INFO)
THE PROJECT IS GNU LICENSED 

TO SUPPORT ME SUBSCRIBE TO ME ON YOUTUBE :D
https://ar07.ml/youtube
'''
...
app.config['MYSQL_HOST'] = 'CRINGE'
app.config['MYSQL_USER'] = 'CRINGE'
app.config['MYSQL_PASSWORD'] = 'CRINGE'
app.config['MYSQL_DB'] = 'CRINGE'
...
def appupdates():
    return redirect('http://notler.ml/updates')
